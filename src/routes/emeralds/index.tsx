...
import { prefetchEmeraldPageData } from "@/data/page-data";
...
export const Route = createFileRoute("/emeralds/")({
	...
	loader: async ({ context }) => {
		...
		const data = context.queryClient.getQueryData<{ seo?: SeoMetadata }>(
			emeraldPageQueryOptions().queryKey,
		);
		return { seo: data?.seo };
	},
...
const miningRegions: {
	...
	{
		name: "Muzo",
		region: "Boyacá occidental",
		colorProfile: "Verde intenso cálido con tonos azulados",
		knownFor:
			"Las esmeraldas más valoradas del mundo. Color profundo, alta saturación y el característico 'verde Muzo' reconocido internacionalmente por GIA.",
		priceNote: "Prima de precio de hasta 30–50% sobre otras regiones",
	},
	{
		name: "Chivor",
		region: "Boyacá oriental",
		colorProfile: "Verde azulado frío y cristalino",
		knownFor:
			"Transparencia excepcional y tonos azul-verde fríos. Hogar de la Esmeralda Patricia (632 ct) expuesta en el Museo Americano de Historia Natural.",
		priceNote: "Alta demanda en el mercado asiático y de coleccionistas",
	},
	{
		name: "Coscuez",
		region: "Boyacá norte",
		...
		knownFor:
			"Gran volumen de producción. Piedras con buena saturación, frecuentemente utilizadas en joyería de alta gama gracias a su relación calidad-precio.",
		priceNote: "Excelente valor para joyería comercial y diseño",
	},
	{
		name: "Gachala",
		region: "Cundinamarca",
		...
		knownFor:
			"Origen de la Esmeralda Gachala (858 ct), una de las mayores del mundo. Producción limitada que confiere exclusividad a cada pieza certificada.",
				...
				<div className="mx-auto max-w-7xl px-6 sm:px-8">
					<div className="mb-12 text-center">
						...
						<p className="mx-auto mt-4 max-w-2xl font-body text-sm leading-relaxed text-brand-primary-dark/70 sm:text-base">
							El origen de una esmeralda define su carácter. Cada región minera
							imprime en la piedra un perfil de color, inclusiones y valor
							únicos que los gemólogos identifican con precisión.
						</p>
					</div>
