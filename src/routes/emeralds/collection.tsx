...
const clarityComparison: {
	...
	{
		attribute: "Aceite cedro típico",
		AAA: "Sin aceite / mínimo",
		AA: "Ligero",
		A: "Moderado",
		B: "Abundante",
	},
	...
	{
		attribute: "Ideal para inversión",
		AAA: true,
		AA: true,
		A: false,
		B: false,
	...
	{
		attribute: "Ideal para joyería diaria",
		AAA: false,
		AA: true,
		A: true,
		B: true,
			...
			<div className="mx-auto max-w-7xl px-4 pb-16 md:px-6 lg:px-8">
				<div className="mb-8 text-center">
					...
					<p className="mt-2 text-sm text-brand-primary-dark/60">
						Referencia técnica para elegir la piedra adecuada a tu propósito
					</p>
				</div>
