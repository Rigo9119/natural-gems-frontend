...
export default function Panel({
  ...
  return (
    <a
      href={href}
      className={`group relative flex flex-1 flex-col items-center justify-center overflow-hidden ${cmpBgClass} px-6 pt-24 pb-12 transition-all duration-500 md:min-h-screen md:px-8 md:py-0 md:hover:flex-[1.15]`}
