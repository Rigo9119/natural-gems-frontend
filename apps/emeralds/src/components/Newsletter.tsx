	...
	return (
		<section className="bg-brand-secondary-terra py-16 sm:py-24">
			<div className="mx-auto max-w-2xl px-6 text-center sm:px-8">
				...
				{status === "success" ? (
					<p className="text-brand-secondary-golden font-body">
					...
					>
						...
						<input
							...
							className="flex-1 rounded-full border border-white/20 bg-white/10 px-5 py-3 text-white placeholder:text-white/50 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-brand-secondary-golden focus-visible:ring-offset-2"
						/>
						<Button
							type="submit"
