...
async function fetchGuides() {
	try {
		const data = await sanityClient.fetch<
			Pick<GuidePost, "_id" | "slug" | "publishedAt">[]
		>(
		...
		handlers: {
			GET: async () => {
				...
				const staticUrls: SitemapUrl[] = [
					...
					{
						loc: `${SITE_URL}/emeralds`,
						changefreq: "weekly",
						priority: "0.9",
						lastmod: today,
					},
					{
						loc: `${SITE_URL}/emeralds/shop`,
						changefreq: "weekly",
						priority: "0.9",
						lastmod: today,
					},
					{
						loc: `${SITE_URL}/emeralds/shop?view=collection`,
						changefreq: "monthly",
						priority: "0.7",
					},
					{
						loc: `${SITE_URL}/emeralds/shop?view=wholesale`,
						changefreq: "monthly",
						priority: "0.7",
					},
					{
						loc: `${SITE_URL}/jewelry`,
						changefreq: "weekly",
						priority: "0.9",
						lastmod: today,
					},
